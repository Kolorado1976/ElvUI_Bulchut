...
local function LoadSkin()
	...
	local function SkinCategoryButton(b, i)
		...
		if not b or not b.Ring or not b.Background then
			return
		end
	...
	if PVPLadderFrame.categoryButtons then
		for i = 1, #PVPLadderFrame.categoryButtons do
			local button = PVPLadderFrame.categoryButtons[i]
			if button then
				SkinCategoryButton(button, i)
			end
		end
	end
	...
	local button = RenegadeLadderFrame.Container.CategoryButton1
	if button then
		SkinCategoryButton(button, 1)
	end
	...
	local btn1 = LadderDummyFrame.Container.CategoryButton1
	if btn1 then SkinCategoryButton(btn1, 1) end

	local btn2 = LadderDummyFrame.Container.CategoryButton2  
	if btn2 then SkinCategoryButton(btn2, 1) end
